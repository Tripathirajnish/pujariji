                  ...
                  <div class="col-lg-6">
                    <div class="card-body p-md-5 mx-md-4">
                      ...
                      <div class="text-center">
                        ...
                        <h4 class="mt-1 mb-5 pb-1 fw-bold">
                            @if(Route::currentRouteName() == 'account.login')
                                @php $type = 0; @endphp
                                Account Login
                            @elseif(Route::currentRouteName() == 'event.login')
                                @php $type = 1; @endphp
                                Event Login
                            @elseif(Route::currentRouteName() == 'customer.login')
                                @php $type = 2; @endphp
                                Customer Support Login
                            @elseif(Route::currentRouteName() == 'panditji.login')
                                @php $type = 3; @endphp
                                Pandit Ji Login
                            @endif
                        </h4>
                      ...
                      @endif
                      <form class="user" action="{{ route('member_login_post') }}" method="POST">
                        @csrf
