...
@section('title','Completed Withdraw Request')
@section('content')
    ...
    <div class="card">
        <div class="card-content">
            <div class="card-header d-flex justify-content-between">
                <h5 class="card-title p-3 pb-0 mb-1">Astrologer Completed Withdraw Request</h5>
             </div>
                        ...
                        <tbody>
                            @foreach ($data as $key => $item)
                                <tr>
                                    ...
                                    <td>
                                        <i class="fa fa-circle-check text-success fs-4"  title="Verify"></i>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
