...
@section('title','Pujari Ji || Rejected Request')
@section('content')
...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="card">
        <div class="card-content">
            <h5 class="card-title p-3 pb-0 mb-1">Rejected Kathavachak List</h5>
                    ...
                    <table class="table table-striped table-hover" id="dataTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                @if(session('type')==base64_encode('master_admin') || session('type')==base64_encode('1'))
                                <td>
                                    <button class="badge bg-success border-0 verify_kathavachak" data-id="{{ $data->kthavchk_id }}" data-bs-toggle="modal" data-bs-target="#exampleModal">Reverify</button>
                                        <span class="px-3">||</span>
                                        <button class="badge bg-danger border-0 delete_this" data-id="{{ $data->kthavchk_id }}" data-url="{{ url('p_delete_kathavachak') }}">Delete Permanently</button>
                                </td>
                                @endif
                            </tr>
                            @endforeach
