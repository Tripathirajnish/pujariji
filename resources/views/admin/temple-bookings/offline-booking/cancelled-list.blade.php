...
@section('title','Offline Cancelled Temple Pooja Booking List')
@section('content')
...
<div class="container">
    <div class="card m-3 mb-0">
        <div class="card-header fw-bold bg-light mb-0 d-flex justify-content-between">
            <h5 class="m-0">Offline Cancelled Temple Pooja Booking List</h5>
...
<div class="modal fade" id="exampleModal3" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <hr class="p-0 m-0">
            <div class="modal-body">
                <form action="{{ url('initate_refund_temple_pooja_booking') }}" method="post" enctype="multipart/form-data">
                    @csrf
