...
<div class="container">
    <div class="card m-3 mb-0">
        <div class="card-header fw-bold bg-light mb-0 d-flex justify-content-between">
            <h5 class="m-0">Refunded Order</h5>
                        ...
                        @foreach ($data as $key => $value)
                            <tr class="">
                                ...
                                <td>
                                    ...
                                    <small class="fa fa-circle-check text-success"> Delivered</small>
                                    @elseif($value->order_status=='3')
                                    <i class="fa fa-cross text-danger"> Cancelled</i>
                                    @elseif($value->order_status=='4')
                                    <i class="fa fa-inr text-warning"> Refunded</i>
                                    @endif
                                </td>
                            </tr>
                        @endforeach
