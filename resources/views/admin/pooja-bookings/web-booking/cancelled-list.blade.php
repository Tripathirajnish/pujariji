            ...
            <table class="table table-sm table-hover small" id="dataTable">
                ...
                <tbody>
                    ...
                    <tr>
                            ...
                            <div class="d-flex justify-space-between">
                                ...
                                <div class="pt-0 ms-1">
                                    <a href="#" class="text-nowrap pooja_details" data-id="{{ $value->booking_id }}" data-bs-toggle="modal" data-bs-target="#exampleModal">{{
                                        virtual_pooja_name($value->pooja_id)['eng_name'] }}</a><br>
                        ...
                        <td>
                            <div class="d-flex justify-space-between">
                                <div class="pt-3 pr-1"><img src="{{ virtual_jajmaan_image($value->jajmaan_id) }}" class="rounded-circle" width="50" height="50" alt=""></div>
                                <div class="pt-2 ms-1">
                                    <a href="#" class="text-nowrap details text-dark" title="View More">{{
                                        virtual_jajmaan_name($value->jajmaan_id) }}</a><br>
                                    <span class="text-nowrap">
                                        <small class="small">{{ $value->jajmaan_id }},</small>
                                        <small class="small">{{ virtual_jajmaan_number($value->jajmaan_id) }}</small><br>
