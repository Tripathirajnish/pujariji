    ...
    <div class="card m-3 mb-0">
        ...
        <form action="{{ route('addNewPoojaPost') }}" class="" method="POST" enctype="multipart/form-data">
            ...
            <div class="card-body row">
                ...
                <div class="col-6 mb-3">
                    ...
                    <select name="pooja_category" class="form-control" id="pooja_category" required>
                        ...
                        @foreach ($data as $value)
                            <option value="{{ $value->cat_id }}" @if($pooja->category_id==$value->cat_id) selected @endif>{{ $value->cat_name }}({{ $value->cat_name_hindi }})</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div class="col-3 m-0 p-0">
                    <img class="p-1" src="{{ url('pooja/pooja_image',$pooja->origional_image) }}" height="150" id="imagePreview" alt="">
                </div>
