                                                        ...
                                                        <div class="card-container">
                                                            <div class="card">
                                                                <img src="https://img1.wsimg.com/isteam/ip/1ba85ad7-f50d-4310-89dc-f7988905e4b3/ae95bd01614e47f26e70e.jpg/:/cr=t:0%25,l:0%25,w:100%25,h:100%25/rs=w:1280"
                                                                    ...
                                                                    <div class="card-content">
                                                                        ...
                                                                        <p>Vastra Daan is a virtuous deed that symbolises compassion and generosity towards those in need. This act of donating clothes will be done in your name at an orphanage or old age home .</p>
                                                                        <div class="d-flex justify-content-between quantity">
                                                                        <p style="color: #ff6300; margin-bottom: 0px;padding:0px">
                                                                        <b>₹1051</b></p>
                                                            ...
                                                            <div class="card">
                                                                <img src="https://img1.wsimg.com/isteam/ip/1ba85ad7-f50d-4310-89dc-f7988905e4b3/ae95bd01614e47f26e70e.jpg/:/cr=t:0%25,l:0%25,w:100%25,h:100%25/rs=w:1280"
                                                                    alt="img">
                                                                    <div class="card-content">
                                                                        <h6>{{$value->name}}<br>{{$value->name_hindi}}</h6>
                                                                        <!-- <p>Vastra Daan is a virtuous deed that symbolises compassion and generosity towards those in need. This act of donating clothes will be done in your name at an orphanage or old age home .</p> -->
                                                                        <div class="d-flex justify-content-between quantity">
                                                                        <p style="color: #ff6300; margin-bottom: 0px;padding:0px"><b>₹{{ $value->price }}</b></p>
                                                                        <button id="add-button" type="button">Add</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="card">
                                                                ...
                                                                <div class="card-content">
                                                                    ...
                                                                    <div class="d-flex justify-content-between quantity">
                                                                    <p style="color: #ff6300; margin-bottom: 0px;padding:0px"><b>₹551</b></p>
