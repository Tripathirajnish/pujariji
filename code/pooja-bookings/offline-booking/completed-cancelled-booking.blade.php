...
@section('title','Offline Completed Cancelled Pooja Booking List')
@section('content')
...
<div class="container">
    <div class="card m-3 mb-0">
        <div class="card-header fw-bold bg-light mb-0 d-flex justify-content-between">
            <h5 class="m-0">Offline Completed Cancelled Pooja Booking List</h5>
            ...
            <table class="table table-sm table-hover small" id="dataTable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex justify-space-between">
                                <div class="pt-2 pr-1"><img src="{{ pujari_image($value->pujari_id) }}" class="rounded-circle" width="50" height="50" alt=""></div>
                                <div class="pt-0 ms-1">
                                    <a href="#" class="text-nowrap details text-dark" title="View More">{{ pujari_name($value->pujari_id) }}</a><br>
                                    <span class="text-nowrap">
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="modal-body table-responsive">
                ...
                <div class="form-group">
                    <label class="fw-bold mx-3">Refund Transection ID : </label>
                    <span id="refund_id"></span>
                </div><hr>
                <div class="form-group">
                    <label class="fw-bold mx-3">Refund ScreenShot : </label>
                    <span id="refund_sc"></span>
                </div>
            </div>
        </div>
    </div>
...
$('.bank_details').click(function(){
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            $('#refund_id').text(response.can_transection_id);
            $('#refund_sc').html('<img src="{{ asset('public/pooja/cancel/') }}/' + response.can_scrnshot + '" alt="Refund Screenshot" height="150">');
        }
    });
});
