...
<div class="container">
    <div class="card m-3 mb-0">
        <div class="card-header fw-bold bg-light mb-0 d-flex justify-content-between">
            ...
            <a href="{{ url('package-list') }}" class="btn btn-primary"><i class="fa fa-list"></i> Package List</a>
        </div>
        @if ($errors->any())
        ...
        <form action="{{ route('addNewPackagePost') }}" class="" method="POST" enctype="multipart/form-data">
            @csrf
