@extends('admin.layout.layouts') @section('title','Send Notification to Vendor') @section('content')
...
<div class="container">
    <div class="card m-3 mb-0">
        <div class="card-header fw-bold bg-light mb-0 d-flex justify-content-between">
            <h5 class="m-0">Send Notification to Vendor</h5>
        </div>
        @if ($errors->any())
        ...
        <div class="card-body">
            <div class="container">
                <form action="{{ url('send-bulk-notification-post') }}" method="post">
                    ...
                    <div class="form-group mb-4">
                        <label for="userSelect fw-bold">Select Vendors:</label>
