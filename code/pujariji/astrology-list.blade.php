...
@section('title','Pujari Ji || Astrology List')
@section('content')
...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="card">
        <div class="card-content">
            <div class="d-flex justify-content-between">
                <h5 class="card-title p-3 pb-0 mb-1">Astrology List</h5>
                <button class="btn btn-primary p-2 me-4 mt-3 add" type="button" data-bs-toggle="modal" data-bs-target="#exampleModal"><i class="fa fa-plus"></i>Add New Astrology</button>
            </div>
                        ...
                        @foreach ($list as $data)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <i class="fa fa-edit text-info edit_data" data-bs-toggle="modal" data-bs-target="#exampleModal" data-id="{{ $data->service_id }}"></i>
                                    <span class="mx-2">||</span>
      ...
      <div class="modal-content">
        ...
        @csrf
            ...
            <div class="modal-body">
                ...
                <div class="input-group mb-3">
                    <span class="input-group-text"> Astrology </span>
  ...
  <div class="modal fade" id="exampleModal2" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="">Astrology Description</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
            </button>
        </div>
            <div class="card-body">
...
<script>
    $('.add').click(function(){
        $('form')[0].reset();
        $('#image').empty();
        $('#modelTitle').text('Add Astrology');
    })

    $('.edit_data').click(function(){
        $('form')[0].reset();
        $('#image').empty();
        $('#modelTitle').text('Edit Astrology');
        var id = $(this).data('id');
        $.ajaxSetup({
            headers: {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                $('#image').append('<img src="' + response.image + '" alt="Astrology Image" width="150" height="100">');
            }
        });
    });
