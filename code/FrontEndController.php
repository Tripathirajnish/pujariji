...
use App\Models\{Blog, JajmaanEnquiry, VirtualPooja, PoojaDetail, PoojaImage, PoojaProcess, PoojaBenefit, VirtualPoojaBooking, PoojaMandir, VirtualPoojaPackage, PoojaVideos};
...
class FrontEndController extends Controller
{
    ...
    public function booking(Request $request, $slug_id){
        ...
        return view('front.booking',compact('pooja','detail','mandir', 'package', 'enquiry'));
    }
