...
@section('title','Astrologer Rejected Requests')
@section('content')
    ...
    <div class="card">
        <div class="card-content">
            <div class="card-header d-flex justify-content-between">
                <h5 class="card-title p-3 pb-0 mb-1">Astrologer Rejected List</h5>
                            ...
                            @foreach ($astro as $key => $data)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button class="badge bg-danger border-0">Delete Permanently</button>
                                    </td>
                                    @endif
                                </tr>
                            @endforeach
