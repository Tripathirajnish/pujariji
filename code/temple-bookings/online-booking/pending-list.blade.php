    ...
    @section('title','Online Pending Pooja Booking List')
    @section('content')
    ...
    <div class="container">
        <div class="card m-3 mb-0">
            <div class="card-header fw-bold bg-light mb-0 d-flex justify-content-between">
                <h5 class="m-0">Online Pending Pooja Booking List</h5>
                    ...
                    <tbody>
                        ...
                        <td>
                            <div class="d-flex justify-space-between">
                                ...
                                <div class="pt-0 ms-1">
                                    <a href="#" class="text-nowrap text-dark pooja_details" data-id="{{ $value->booking_id }}" data-bs-toggle="modal" data-bs-target="#exampleModal">{{
                                        temple_pooja_name($value->pooja_id)['eng_name'] }}</a><br>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="modal-body table-responsive">
                    ...
                    <div class="form-group">
                        <label class="fw-bold mx-3">Account Hol der : </label>
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="modal fade" id="exampleModal2" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    $('.update_pujari_details').click(function(){
        ...
        $.ajax({
            type: "POST",
            url: "{{ url('get-temple-booking-details') }}",
            data: {data:id},
        ...
        $.ajax({
            type: "POST"
            , url: "{{ url('get_temple_pooja_package_inclusion_detail') }}"
            , data: {
                data: id
            }
            , success: function(response) {
