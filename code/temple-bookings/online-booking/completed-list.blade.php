                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex justify-space-between">
                                ...
                                <div class="pt-0 ms-1">
                                    <a href="#" class="text-nowrap  text-dark details" title="View More">{{ temple_pooja_name($value->pooja_id)['eng_name'] }}</a><br>
                        ...
                        <td>
                            <div class="d-flex justify-space-between">
                                ...
                                <div class="pt-2 ms-1">
                                    <a href="#" class="text-nowrap text-dark details" title="View More">{{ jajmaan_name($value->jajmaan_id) }}</a><br>
                                    <span class="text-nowrap">
                        ...
                        <td width="15%">
                            <div class="d-flex justify-space-between">
                                <div class="pt-2 ms-1">
                                    <a href="javascript:void()" class="text-nowrap text-dark details" title="View More">Total : ₹{{ $value->total_price }}</a>,
