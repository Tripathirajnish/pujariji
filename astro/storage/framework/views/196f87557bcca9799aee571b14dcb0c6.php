                        ...
                        <div class="input mt-3">
                            <div>
                                ...
                                <input type="text" name="email" id="email" class="form-control"
                                    placeholder="Astrologer Email" onkeypress="return validateJavascript(event);"  required>
                            </div>
                        </div>
                        <div class="input mt-3">
                            <div>
                                ...
                                <input type="text" name="contactNo" id="contactNo" class="form-control"
                                    placeholder="ContactNo"  required>
                            </div>
                        </div>
                                ...
                                <div class="input mt-3">
                                    <div>
                                        ...
                                        <input onkeypress="return validateJavascript(event);" type="text" name="reportRate" id="reportRate" class="form-control"
                                            placeholder="Reprot Rate"  required>
                                    </div>
                                </div>
                            </div>
                            <div class="intro-y col-span-6 md:col-span-6">
...
<?php echo $__env->make('../layout/' . $layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u844460753/domains/pujariji.com/public_html/astro/resources/views/pages/astrologer-add.blade.php ENDPATH**/ ?>