                    ...
                    <?php $__currentLoopData = $rechargeAmount; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="intro-x">
                            ...
                            <td>
                                ...
                                <div class="font-medium whitespace-nowrap"><?php echo e($item->cashback); ?>%
                                </div>
                            </td>
...
<?php echo $__env->make('../layout/' . $layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/resources/views/pages/recharge-amount.blade.php ENDPATH**/ ?>