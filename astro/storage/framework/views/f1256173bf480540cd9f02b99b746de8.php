                                    ...
                                    <div class="input">
                                        <div>
                                            ...
                                            <select data-placeholder="Select users" class="form-control select2" id="userId" name="userId">
                                                ...
                                                <option value="<?php echo e($userdata->userId); ?>" required><?php echo e($userdata->userName); ?> - <?php echo e($userdata->usercontactNo); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
...
<?php echo $__env->make('../layout/' . $layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u844460753/domains/pujariji.com/public_html/astro/resources/views/pages/customer-list.blade.php ENDPATH**/ ?>