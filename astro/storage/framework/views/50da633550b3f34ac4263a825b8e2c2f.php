    ...
    <div class="d-inline addbtn intro-y col-span-12">
        <nav class="w-full sm:w-auto sm:mr-auto">
            <ul class="pagination" id="pagination">
                ...
                <?php
                    $showPages = 17; // Number of pages to show at a time
                ...
                <?php if($startPage > 1): ?>
                    <li class="page-item">
                        <a class="page-link"
                            href="<?php echo e(route('kundaliearning', ['page' => 1, 'searchString' => $searchString])); ?>">1</a>
                    </li>
                    <?php if($startPage > 2): ?>
                ...
                <?php for($i = $startPage; $i <= $endPage; $i++): ?>
                    <li class="page-item <?php echo e($page == $i ? 'active' : ''); ?>">
                        <a class="page-link"
                            href="<?php echo e(route('kundaliearning', ['page' => $i, 'searchString' => $searchString])); ?>"><?php echo e($i); ?></a>
                    </li>
                <?php endfor; ?>
                ...
                <?php if($endPage < $totalPages): ?>
                    ...
                    <li class="page-item">
                        <a class="page-link"
                            href="<?php echo e(route('kundaliearning', ['page' => $totalPages, 'searchString' => $searchString])); ?>"><?php echo e($totalPages); ?></a>
                    </li>
                <?php endif; ?>
...
<?php echo $__env->make('../layout/' . $layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u844460753/domains/pujariji.com/public_html/astro/resources/views/pages/kundali-earnings.blade.php ENDPATH**/ ?>