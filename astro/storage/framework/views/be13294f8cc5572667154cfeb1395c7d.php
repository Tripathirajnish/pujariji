    ...
    <nav id="pageheader"class="navbar navbar-expand-lg  theme-nav fixed-top">
        <div class="container" style="display:initial!important">
            <a class="navbar-brand" href="<?php echo e(url('home')); ?>#home" [pageScrollOffset]="75" pageScroll><img
                    src="/<?php echo e($logo->value); ?>" alt="logo"
                    style="height: 50px;width: 50px;vertical-align: middle !important;"><span
                    style="font-size:42px;color:#fff;vertical-align: middle !important;">&nbsp;Pujariji</span></a>
    ...
    <footer class="cpoy-right-bg">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12 text-center">
                    <p class="copyright">Copyright by Pujariji Powered by Pujariji</p>
                </div>
            </div>
        </div>
    </footer>
...
<?php /**PATH /home/u844460753/domains/pujariji.com/public_html/astro/resources/views/layout/app.blade.php ENDPATH**/ ?>