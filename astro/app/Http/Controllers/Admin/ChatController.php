    ...
    public function getFireStoredata(Request $req)
{
    try {
        ...
        $response = $httpClient->get("https://firestore.googleapis.com/v1/projects/astro-pujari-ji/databases/(default)/documents/supportChat/{$chatId}/userschat/{$req->id}/messages");
    ...
    {
        try {
            $apiEndpoint = "https://firestore.googleapis.com/v1/projects/astro-pujari-ji/databases/(default)/documents/";
