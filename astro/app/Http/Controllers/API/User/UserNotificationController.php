        ...
        try {
           ...
           // $userNotification = UserNotification::query();
            // $userNotification = $userNotification->where('userId', '=', $id)->OrderBy('id', 'DESC');
             ...
             ->leftJoin('user_device_details as chat_device', 'chat_device.userId', '=', 'chatrequest.userId')
             ->leftJoin('user_device_details as call_device', 'call_device.userId', '=', 'callrequest.userId')
             ...
             ->select(
                 ...
                 DB::raw('IF(chat_device.userId IS NOT NULL, chat_device.fcmToken, NULL) as fcmToken'),
                 DB::raw('IF(call_device.userId IS NOT NULL, call_device.fcmToken, NULL) as fcmToken')
             )
