        ...
        <nav class="w-full sm:w-auto sm:mr-auto">
            <ul class="pagination" id="pagination">
                ...
                @if ($startPage > 1)
                    <li class="page-item">
                        <a class="page-link"
                            href="{{ route('reportrequest', ['page' => 1, 'searchString' => $searchString]) }}">1</a>
                    </li>
                    @if ($startPage > 2)
                ...
                @for ($i = $startPage; $i <= $endPage; $i++)
                    <li class="page-item {{ $page == $i ? 'active' : '' }}">
                        <a class="page-link"
                            href="{{ route('reportrequest', ['page' => $i, 'searchString' => $searchString]) }}">{{ $i }}</a>
                    </li>
                @endfor
                ...
                @if ($endPage < $totalPages)
                    ...
                    <li class="page-item">
                        <a class="page-link"
                            href="{{ route('reportrequest', ['page' => $totalPages, 'searchString' => $searchString]) }}">{{ $totalPages }}</a>
                    </li>
                @endif
